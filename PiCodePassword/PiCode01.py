...
generate_method = input("Choose password generation method (1 for CodeLength and Segments, 2 for Key): ")
...
if generate_method == "1":
    ...
    print("Invalid input. Please choose either 1 or 2 for the password generation method.")